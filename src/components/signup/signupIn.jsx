...
export default function SignupIn({ whichSign, userContent, authQuestion }) {
  ...
  //     if (
  //       e.target.type === "text" &&
  //       regfullName.test(e.target.value) === true
  //     ) {
  //       console.log(e.target.value);
  //       setCurrentUserinfo(e.target.value);
  //     } else if (
  //       e.target.type === "email" &&
  //       regEmail.test(e.target.value) === true
  //     ) {
  //       console.log(e.target.value);
  //       setCurrentUserinfo(e.target.value);
  //     } else if (
  //       e.target.type === "password" &&
  //       regPassword.test(e.target.value) === true
  //     ) {
  //       console.log(e.target.value);
  //       setCurrentUserinfo(e.target.value);
  //     }
  //   } else {
  //     if (e.target.type === "email" && regEmail.test(e.target.value) === true) {
  //       setCurrentUserinfo(e.target.value);
  //     } else if (
  //       e.target.type === "password" &&
  //       regPassword.test(e.target.value) === true
